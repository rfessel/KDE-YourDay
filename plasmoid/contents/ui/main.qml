...
PlasmoidItem {
    ...
    // Relógio em dois andamentos: clockTick (saudação, anel do dia, Resumo)
    // bate 1x/min; root.now com segundos é refrescado a 1 Hz só para o tooltip.
    Timer {
        id: clockTimer
        interval: 60000
        repeat: true
    ...
    fullRepresentation: Rectangle {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                // Troca de aba sem custo: sem fade/animacão (as páginas leves
                // carregam síncronas e a Agenda mostra placeholder próprio).
                StackLayout {
                    id: tabFade
                    anchors.fill: parent
